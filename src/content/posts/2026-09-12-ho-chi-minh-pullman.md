...
locations:
  - name: "떤선녓국제공항"
    ...
    order: 1
    visitDate: "9/12-9/13"
    note: "새벽 도착·입국 후 공항 ATM 약 1,000,000 VND 출금 예정, 유니온페이는 BIDV 우선·마스터카드는 수수료 비교 → 포하 → 06시 마사지. 조회 03:35 도착, 실제 예약표 대조"
  - name: "포하 (PHỞ HÀ)"
    lat: 10.7719657
    lng: 106.7052281
    type: restaurant
...
| 04:20∼04:30 목표 | **공항 BIDV ATM 약 1,000,000 VND 출금·차량 호출** | 입국 후 5∼10분. 유니온페이 BIDV 우선, 마스터카드는 수수료 비교. 늦으면 포하 축소 |
...
### 마스터카드·유니온페이 ATM 비교 · 2026-09-07 확인

**한국 등 베트남 외 국가에서 발급한 카드 기준**이다. 유니온페이는 **BIDV 우선**, 마스터카드는 **VPBank를 먼저 비교할 후보**로 두되 공항에 해당 기기가 있다고 가정하지 않는다. 이번 공항 출금은 약 100만 동이며, 무료 ATM을 찾으려고 다른 터미널·시내 은행을 경유하지 않는다.

| 카드 브랜드 | 은행 | 현지 ATM 수수료 확인 내용 | 이번 여행에서의 선택 |
|---|---|---|---|
| **UnionPay 유니온페이** | **BIDV** | **BIDV 부과 출금 수수료 면제**, 공식 2026-01-06 적용표 | 공항에서 우선 이용. 카드 발급사 비용은 별도 확인 |
| **Mastercard 마스터카드** | **BIDV** | **4.5∼5%, 최소 90,000 VND**, VAT·카드 발급사 비용 별도 | 100만 동 출금에도 최소 9만 동 + VAT가 적용되므로 비용 확인 후 선택 |
| **Mastercard 마스터카드** | **VPBank** | 무료 출금 여행 후기·비교 자료가 있으나, 최신 해외 발급 카드 공식표로 일괄 면제 확인 못 함 | 가까이 기기가 있으면 먼저 비교. 최종 화면의 실제 수수료 확인 |
| Mastercard / UnionPay | **MSB** | 여행 안내에 2024-07-24 유료화 정정. 현재 해외 발급 카드·브랜드별 정확한 요금은 미확인 | **무료 출금용 1순위에서 제외**, 기기 화면 요금이 유리할 때만 선택 |
| Mastercard / UnionPay | **TPBank** | 유료화 안내가 있어 과거 무료 목록을 그대로 적용하기 어려움. 브랜드별 최신 공식표 미확인 | 무료라고 가정하지 않고 화면 요금 비교 |

**BIDV 공식 근거:** 타행 발급 카드 수수료표 19쪽은 해외 발급 Mastercard와 UnionPay/DFS를 구분한다. 최소 수수료가 90,000 VND이므로 1,000,000 VND × 4.5∼5% = 45,000∼50,000 VND보다 **최소 금액이 우선**한다. 2025년 자료의 최소 60,000 VND보다 최신 표를 적용했다. [BIDV 공식 2026 수수료표 — 19쪽](https://bidv.com.vn/wps/wcm/connect/c4a4a907-713b-43fd-90ea-96b6a3ccc676/Bieu%2Bphi%2Bup%2Bweb%2B30.01.26.pdf?CVID=pMesill&MOD=AJPERES&amp%3Battachment=true&id=1763006437516).

**VPBank·MSB·TPBank의 확인 수준:** VPBank는 마스터카드 무료 출금 참고 자료를 후보 선정에 사용했으며, 무료를 보장하는 공식 정책으로 표시하지 않았다. MSB와 TPBank는 여행 안내의 유료화 정정을 참고했다. 해당 정정만으로 모든 카드의 현재 요율을 확정하지는 않는다. [VPBank 비교 자료](https://travel-atm-cost.jso.app/en/countries/vietnam/atms/vpbank/), [MSB·TPBank 유료화 정정이 있는 여행 안내](https://www.youtube.com/watch?v=mjRtjWSJOuc). **MSB가 발급한 카드의 ‘ATM 무료’ 상품 혜택을 한국 발급 마스터카드에도 적용되는 것으로 해석하지 않는다.** [MSB 자체 카드 상품 안내](https://www.msb.com.vn/khach-hang-ca-nhan/the/msb-mastercard-platinum-fcb/).

현지 ATM 운영 수수료와 한국 카드사의 해외 인출·브랜드 수수료는 별개다. 예를 들어 트래블로그 안내도 현지 ATM 운영사 수수료는 지원하지 않는다고 명시한다. **보유 카드의 상품명·브랜드·잔액 통화·면제 한도**를 카드 앱에서 대조하고, 은행 로고만 보고 총수수료가 0원이라고 계산하지 않는다. [하나카드 해외 인출 안내](https://m.hanacard.co.kr/mobile_web/landing/travlog/a29/check.jsp).

공항에서는 **유니온페이가 있으면 BIDV → 마스터카드만 있으면 같은 도착 구역 ATM의 실제 요금 비교 → 수수료를 수용하고 100만 동 출금 또는 필요한 현금 환전** 순서로 판단한다. 5∼10분 이상 은행 찾기를 늘리지 않고 06시 마사지 예약을 유지한다. 출금액·표의 수수료는 아직 지출 합계에 넣지 않았으며 실제 발생 비용만 나중에 기록한다.

[사용자가 제공한 네이버 참고 글](https://m.blog.naver.com/travelwoody/223614224109)은 원문 열람이 차단되어 그 글의 표·금액을 확인한 것으로 인용하지 않았다. 위 비교는 별도로 확인한 은행 자료와 구분 표시한 여행 자료를 기반으로 한다.
