...
| 날짜 | 동선 | 하루의 마무리 |
|---|---|---|
| 9/24 목 | 김포(면세점·신상 프리미엄 라운지) → 12:00 가오슝 도착(e-Gate 1분·공항 1층 이지카드 교환) → **숙소 짐보관 & 얼리 체크인 전 까르푸 아이허점(우버 8분, 쇼핑·푸드코트 점심·5% 현장 즉시 택스리펀) [또는 숙소 도보 5분 대우육면·버블티]** → 15:00 체크인/휴식 → **한신 아레나(스벅 1+1 쿠폰 & 딘타이펑 대기 중 지우전난 펑리수·누가크래커 쇼핑)** → 루이펑 야시장(천사지파이) → **위스키샵(남위해양주행/카발란쇼룸)** | 21:00 호텔, **달리 치약 & 쇼핑템 캐리어 즉시 사전 패킹** |
...
## 9/24 목 · 첫날 도착(정오) & 얼리 체크인 활용 까르푸 원스톱 쇼핑(또는 로컬 미식), 한신 아레나 쇼핑, 루이펑 야시장
...
13:35 호텔 프런트에 캐리어를 무료 보관(1분 컷)한 뒤, 취향과 선호에 맞춰 **[선택 1: 까르푸 대형마트 원스톱 코스 (메인 추천)]** 또는 **[선택 2: 로컬 미식 & 디저트 산책 코스 (대안 플랜)]** 중 선택하여 알차게 보낼 수 있습니다:

#### 🏆 [선택 1 (메인 추천 - 대형마트 원스톱 공략형)] 까르푸 아이허점 쇼핑 & 점심 & 즉시 택스리펀
*호텔 체크인 전 대형마트를 먼저 정복하여 대량의 쇼핑 짐을 15:00 체크인과 동시에 객실에 바로 수납하고, 2~4일 차 일정 내내 양손 가볍게 다니는 스마트한 플랜!*
1. **13:35 호텔 짐보관 후 우버 탑승**: 호텔 로비에서 우버(Uber)를 호출해 **[까르푸 아이허점 (家樂福 愛河店)](https://maps.app.goo.gl/fPioKXCNr9VqWssw7)**으로 이동 (차량 약 8분, 편도 약 100~120 TWD).
...
3. **14:50 우버로 호텔 복귀 & 15:00 정규 체크인**: 우버를 타고 호텔로 귀환하여 15:00 정규 체크인. 쇼핑한 마트 박스와 기념품을 객실에 즉시 올려두고 에어컨 아래에서 40분간 쾌적한 휴식!

#### 🍜 [선택 2 (대안 플랜 - 로컬 미식형)] 숙소 도보 5분 대우육면 로컬 점심 & 마구티 과일티 디저트
*차량 이동 없이 숙소 코앞에서 가오슝 현지인 찐 로컬 맛집과 대만 대표 과일티를 즐기며 여유롭게 체크인을 기다리는 코스!*
1. **13:35 호텔 짐보관**: 캐리어를 호텔 프런트에 맡기고 가벼운 복장으로 출발.
...
| 13:35∼14:50 | **[메인 플랜 A] 까르푸 아이허점 원스톱 쇼핑 & 점심 & 즉시 택스리펀**<br>*(대안 플랜 B: 대우육면 로컬 점심 & 마구티 즈즈망고)* | • **플랜 A (메인 추천)**: 호텔 앞 우버 탑승(8분, 약 100~120 TWD) → **[까르푸 아이허점](https://maps.app.goo.gl/fPioKXCNr9VqWssw7)** 푸드코트 점심 & 대형마트 필수 쇼핑템(달리 치약 묶음팩, 만한대찬, 닥터큐 젤리, 밀크티) 카트 가득 장보기 → **1층 고객서비스센터에서 5% 현장 즉시 현금 환급(2,000 NTD 이상 시)** → 우버 타고 호텔 복귀<br>• **플랜 B (대안 플랜)**: 숙소 도보 5분 **[대우육면](https://maps.app.goo.gl/hXfR9jY8j1K6Z9pE7)** 홍샤오/칭둔 우육면·소힘줄 점심 식사 후 **마구티(MACU)** 즈즈망고 테이크아웃 |
| 14:50∼15:45 | **호텔 체크인(15:00) & 방 입실·쇼핑짐 수납·샤워·휴식** | URBAN HOTEL33 체크인. (플랜 A 진행 시 마트 쇼핑짐 즉시 객실 수납 완료!) 시원한 방에서 세안 및 40분간 쾌적한 체력 재충전 |
...
[호텔 → 까르푸 아이허점 (우버)](https://maps.app.goo.gl/fPioKXCNr9VqWssw7) · [호텔 → 대우육면](https://www.google.com/maps/dir/?api=1&origin=URBAN+HOTEL33+Kaohsiung&destination=Da+Niu+Beef+Noodles+Kaohsiung&travelmode=walking) · [호텔 → 한신 아레나](https://www.google.com/maps/dir/?api=1&origin=URBAN+HOTEL33+Kaohsiung&destination=Din+Tai+Fung+Hanshin+Arena&travelmode=transit) · [한신 아레나 → 루이펑](https://www.google.com/maps/dir/?api=1&origin=Din+Tai+Fung+Hanshin+Arena&destination=Ruifeng+Night+Market&travelmode=walking).
