...
tags: ["대만", "가오슝", "소류구", "소류도", "달리치약", "펑리수", "누가크래커", "POYA", "PX마트", "전기스쿠터", "바다거북키링", "수기부잠", "스노클링", "바다거북", "클룩일일투어", "한국어가이드", "불광산", "불타기념관", "연지담", "URBANHOTEL33", "천사지파이", "딘타이펑", "리우허야시장", "라오마빙수", "망고눈꽃빙수", "개지양생관", "SKMPark", "남위해양주행", "위스키보틀샵"]
...
| 20:35∼21:05 | **숙소 앞 대형마트(PX Mart & POYA) 원스톱 장보기** | 숙소 도보 2분 나란히 위치.<br>• **POYA**: DARLIE 달리 치약(초록 오리지널, 베이킹소다 화이트닝, 차콜 등) 묶음팩 (2,000 NTD 이상 구매 시 택스리펀 신청 가능)<br>• **PX Mart**: 만한대찬 컵라면, 3시 15분 밀크티 티백, 닥터큐 젤리, 18일 맥주 |
...
> [!TIP]
> **대만 위스키 보틀샵(남위해양주행) 쇼핑 & 주류 2병 한국 면세 반입 완벽 가이드**
> - **방문 보틀샵**: **[남위해양주행 가오슝 푸민점 (南威海洋酒行-高雄富民店)](https://maps.app.goo.gl/4mksKCj4XeMNTj269)**
>   - **위치**: 치엔진/쥐단 상권 (MRT R13 아오쯔디역 3번 출구 도보 5분, 루이펑 야시장 도보 10분).
>   - **특징**: 가오슝 현지 위스키 애호가들이 찾는 전문 리쿼샵. 카발란(Kavalan) 솔리스트(Solist) 싱글 캐스크, 독점 싱글 배럴 보틀, 스카치/버번/일본 위스키 등 백화점이나 면세점에 없는 희귀 보틀과 뛰어난 가격대를 갖추고 있습니다.
> - **대한민국 관세청 1인 주류 면세 규정 (2병 면세 기준)**:
>   - **면세 규격**: **1인당 최대 2병 (합산 용량 2.0L 이하, 합산 총액 미화 400달러 이하)**.
>   - 시내 보틀샵에서 2병을 구매해 한국 입국 시 여행자 휴대품 신고서에 성실 기재하면 세금(관세·주세·교육세)이 **100% 면세(0원)** 처리됩니다.
> - **시내 구매 주류의 기내/위탁 패킹 필수 팁**:
>   - 시내 매장에서 구매한 100ml 초과 주류는 **보안검색대 통과 불가로 절대 기내 휴대 반입이 안 됩니다**.
>   - **반드시 위탁 수하물(체크인 캐리어)**에 부쳐야 하므로, 1일 차 밤 호텔에서 수건이나 옷가지로 병목과 유리병 바닥을 두껍게 감싸 캐리어 정중앙에 완충 배치해 두면 2~4일 차 일정 내내 파손 걱정 없이 안전하게 한국까지 운반할 수 있습니다.
