...
tags: ["대만", "가오슝", "소류구", "소류도", "달리치약", "펑리수", "누가크래커", "POYA", "PX마트", "전기스쿠터", "바다거북키링", "수기부잠", "스노클링", "바다거북", "클룩일일투어", "한국어가이드", "불광산", "불타기념관", "연지담", "URBANHOTEL33", "천사지파이", "딘타이펑", "리우허야시장", "라오마빙수", "망고눈꽃빙수", "개지양생관", "SKMPark", "남위해양주행", "카발란", "카발란쇼룸", "대만위스키"]
