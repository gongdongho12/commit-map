...
* 🏬 **Day 1 (9/24 목) : 체크인 및 쇼핑 투어**
  ...
  - **핵심 일정**: 김포공항 신규 프리미엄 라운지 조식 → 12:00 가오슝 도착 & 이지카드 수령/충전 → 호텔 짐보관 후 얼리 체크인 골든타임 활용(**[선택 1] 까르푸 아이허점 원스톱 쇼핑 & 푸드코트 점심 & 5% 현장 즉시 환급** 또는 **[선택 2] 대우육면 로컬 노포 점심 & 마구티 즈즈망고**) → 15:00 호텔 체크인 & 짐 정리 → 한신 아레나(딘타이펑 저녁 & 130년 전통 지우전난 펑리수) → 루이펑 야시장 천사지파이 → 카발란 쇼룸 / 남위해양주행 위스키 2병 구매 후 캐리어 안전 패킹.
...
timeline
  ...
  9/24 목 (체크인 & 쇼핑 투어) : 12:00 가오슝 도착 & 이지카드
...
|---|---|---|---|
| 9/24 목 | **체크인 및 쇼핑 투어** | 김포(면세점·신상 프리미엄 라운지) → 12:00 가오슝 도착(e-Gate 1분·공항 1층 이지카드 교환) → **숙소 짐보관 & 얼리 체크인 전 까르푸 아이허점(MRT 3분+도보/버스, 쇼핑·푸드코트 점심·5% 현장 즉시 택스리펀) [또는 숙소 도보 5분 대우육면·버블티]** → 15:00 체크인/휴식 → **한신 아레나(MRT 이동, 스벅 1+1 쿠폰 & 딘타이펑 대기 중 지우전난 펑리수·누가크래커 쇼핑)** → 루이펑 야시장(도보 5분) → **위스키샵(남위해양주행/카발란쇼룸)** | 21:00 호텔, **달리 치약 & 쇼핑템 캐리어 즉시 사전 패킹** |
...
> 대만은 야시장 포차, 로컬 노포 식당, 소류구 스노클링 샤워/락커비 등에서 여전히 현금(TWD) 사용 비중이 높습니다. 한국의 해외 결제/출금 카드(트래블로그, 트래블월렛, 트래블고 등)를 지참할 때 **어떤 현지 은행 ATM을 이용하느냐에 따라 현지 수수료(건당 100 NTD, 한화 약 4,200원) 발생 여부**가 완전히 갈립니다.
>
> #### 1. 대만 주요 은행별 해외카드 ATM 현지 수수료 비교
> | 은행명 (한글/현지명) | 로고 및 위치 특징 | 지원 브랜드 | 현지 수수료 (Surcharge) | 비고 및 이용 추천도 |
> |---|---|---|:---:|---|
> | **국태세화은행<br>(Cathay United / 國泰世華)** | **초록 바탕 노란/초록 나무 로고 🌳**<br>• 가오슝 MRT 전 역사 내 설치<br>• 시내 대다수 세븐일레븐(7-11) | Master, UPI, Visa | **0원 (완전 무료)** | ⭐⭐⭐⭐⭐ **[접근성 1위]** 지하철역 이동 시 역사 내 ATM에서 가장 쉽게 무료 출금 가능 |
> | **대만은행<br>(Bank of Taiwan / 臺灣銀行)** | **대만 제1국책은행**<br>• 가오슝 공항 1층 입국장 정면<br>• 시내 주요 금융가 | Master, UPI, Visa | **0원 (완전 무료)** | ⭐⭐⭐⭐⭐ **[입국 즉시 1위]** 공항 짐 찾고 게이트 나오자마자 1분 컷 무료 출금 최적 |
> | **메가국제상업은행<br>(Mega Bank / 兆豐國際商業銀行)** | **주요 외환전문 국책은행**<br>• 공항 청사 및 시내 지점 | Master, UPI, Visa | **0원 (완전 무료)** | ⭐⭐⭐⭐ 수수료 면제. 공항 및 주요 지점에서 안전하게 인출 가능 |
> | **타이완합작금고<br>(Taiwan Cooperative / 合作金庫)** | 국공유 대형 협동은행 | Master, UPI, Visa | **0원 (완전 무료)** | ⭐⭐⭐ 시내 지점 이용 시 무료 |
> | **중국신탁은행<br>(CTBC / 中國信託銀行)** ⚠️ | 일부 세븐일레븐(7-11) 및 패밀리마트 | Master, UPI, Visa | **건당 100 NTD 부과**<br>(약 4,200원) | ❌ **[주의]** 편의점 ATM 중 CTBC 로고 기기는 해외카드 수수료가 청구되므로 비추천 |
> | **타이신은행<br>(Taishin / 台新銀行)** ⚠️ | 패밀리마트(全家) 대다수 설치 | Master, UPI, Visa | **건당 100 NTD 부과**<br>(약 4,200원) | ❌ **[주의]** 패밀리마트 ATM의 대부분을 차지하며 현지 수수료가 발생하므로 회피 필수 |
>
> #### 2. 카드 브랜드(Master vs UnionPay vs Visa) 및 제휴 상품별 합리적인 선택
> 1. **하나 트래블로그 (Mastercard vs UnionPay)**:
>    - **환전 수수료**: 하나머니 앱 충전 시 TWD 100% 무료 환율 우대.
>    - **유니온페이(UPI) 제휴**: 대만은 중화권 국가로 유니온페이 네트워크가 국가 표준 수준으로 깊게 정착되어 있어, 로컬 오프라인 결제 및 ATM 인식 에러가 가장 적습니다. 국태세화은행, 대만은행 ATM에서 100% 무료 출금.
>    - **마스터카드(Master) 제휴**: 글로벌 범용성이 뛰어나며, 국태세화은행 및 대만은행 ATM에서 동일하게 무료 출금 가능.
> 2. **트래블월렛 & 트래블고 (Visa / Master)**:
>    - **비자(Visa) 제휴**: 트래블월렛의 기본 네트워크로, 대만 현지에서 **국태세화은행(MRT역·7-11)** 또는 **대만은행** ATM을 이용하면 현지 수수료 없이 인출할 수 있습니다.
> 3. **가장 합리적이고 안전한 추천 조합**:
>    - **트래블로그 (유니온페이 또는 마스터)** + **트래블월렛/고 (비자)** 실물 카드 2장을 챙깁니다.
>    - 현금은 비행기 도착 직후 **가오슝 공항 1층 입국장의 '대만은행(Bank of Taiwan)' ATM** 또는 **MRT 신이국소역/미려도역 내 '국태세화은행(초록 나무 로고)' ATM**에서 1회 3,000~5,000 NTD 정도만 출금하는 것이 가장 깔끔하고 수수료 0원으로 합리적입니다.
>
> #### 3. 현지 ATM 실전 출금 실패 없는 4원칙
> - ① **비밀번호(PIN) 입력**: 화면에 비밀번호를 요구할 때 보통 **한국 4자리 비밀번호**를 입력합니다. 만약 6자리 입력을 요구하거나 인식이 안 될 경우 **'비밀번호 4자리 + 00'** (예: 비번이 1234라면 `123400`)을 입력하세요.
> - ② **계좌 종류 선택**: 계좌 선택 화면에서 **`Savings Account(저축예금)`** 또는 `Checking Account(당좌예금)` (또는 `Default`)를 선택합니다.
> - ③ **DCC 환전 거부 (현지 통화 선택)**: ATM에서 출금 통화 전환 여부를 물어보면 무조건 **대만 달러(TWD)**를 선택해야 카드사 이중 환전 수수료가 발생하지 않습니다.
> - ④ **수수료 경고 메시지 확인**: 인출 최종 단계 화면에 *"이 거래에는 수수료 100 TWD가 부과됩니다"*라는 문구가 나타난다면 즉시 **[Cancel / 取消]**을 누르고, 바로 인근 지하철역의 **국태세화은행(초록 나무 로고)** ATM으로 이동하세요.
...
| 20:35∼21:05 | **숙소 앞 대형마트(PX Mart & POYA) 또는 여유로운 야식 픽업** | • 낮에 까르푸를 완료했다면: 숙소 앞 편의점/마트에서 시원한 18일 생맥주와 야식만 가볍게 픽업하여 여유로운 마무리<br>• 낮에 대우육면을 즐겼다면: 숙소 도보 2분 **POYA**(달리치약 묶음팩) & **PX Mart**(라면, 과자, 밀크티)에서 필수 장보기 완료 |
