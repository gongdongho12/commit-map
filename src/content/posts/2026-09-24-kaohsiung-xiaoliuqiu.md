...
>
> #### 2. 가오슝 현지 추천 인출 거점 (공항 & 숙소 앞 PX Mart)
> 1. **가오슝 공항 1층 입국장**: 수하물 찾고 나오자마자 게이트 정면에 있는 **대만은행(Bank of Taiwan) ATM**에서 3,000~5,000 NTD 1분 컷 무료 출금.
> 2. **가오슝 MRT 전 역사 (미려도역, 신이국소역 등)**: 지하철 개찰구 안팎에 **국태세화은행(초록 나무 로고) ATM** 완비.
> 3. **숙소 바로 앞 PX Mart 신이점 (全聯福利中心, 도보 2분)**:
>    - 대만 현지 대형마트인 PX Mart 내부에는 **국태세화은행 ATM(國泰世華銀行ATM)**이 기본 입점되어 있어, 굳이 편의점을 찾아 헤맬 필요 없이 숙소 코앞에서 마스터/비자/UPI 모두 수수료 0원으로 안전하게 출금 가능합니다.
>    - *(주의)* **PX Mart 매장 결제 시 한국 해외 신용카드는 결제 불가**합니다! 현지 카드만 지원되므로 쇼핑 결제는 **현금 또는 이지카드(EasyCard)**로만 가능합니다.
>
> #### 3. 실전 ATM 출금 완벽 매뉴얼 (100 TWD 소액권 분할 꿀팁)
